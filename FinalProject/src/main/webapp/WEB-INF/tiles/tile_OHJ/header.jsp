		...
		<nav class="navbar navbar-expand-lg navbar-light pt-2" style="background-color: black;">
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
			  <ul class="navbar-nav mx-auto" style="font-size:14pt;">
			     ...
			     <li class="nav-item active mx-2" style="text-align: center;">
			     	<a class="nav-link menufont_size" style="color:white;" href="<%= ctxPath %>/recentList.gw"><i class="fas fa-chalkboard fa-lg"></i><br>게시판</a>
			     </li>
			     <li class="nav-item active mx-2" style="text-align: center;">
			  ...
			  <ul class="navbar-nav list-group-horizontal mt-sm-0 mt-2 ml-auto nav_text">
		    	...
		    	<li class="nav-item ml-2" ><a class="nav-link far fa-user fa-lg" style="color:white" href="<%= ctxPath%>"></a></li>
	   		  </ul>	  
			</div>
